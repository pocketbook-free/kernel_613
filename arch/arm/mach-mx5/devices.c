...
*/
#define GPIO_6_8	(5*32 + 8)
#define GPIO_6_9	(5*32 + 9)
#define GPIO_4_3	(3*32 + 3)
#define GPIO_4_4	(3*32 + 4)
#define GPIO_4_14	(3*32 + 14)
#define GPIO_2_9	(1*32 + 9)
#define GPIO_2_10	(1*32 + 10)
#define GPIO_2_14	(1*32 + 14)


#define GPIO_KEY_CONF		0x01
#define GPIO_KEY_LEFT		0x02
#define GPIO_KEY_RIGHT  	0x03
#define GPIO_KEY_DOWN		0x04
#define GPIO_KEY_UP		0x05
#define GPIO_KEY_BACKWARD	0x06
#define GPIO_KEY_FORWARD	0x07
#define GPIO_KEY_POWER		0x08
...
static struct gpio_keys_button gpio_keys[] = {
	...
	},
	{
		.code   = GPIO_KEY_UP,
                ...
                .longpress_time = 2000,
                .wakeup = 1,
                .key_status = "up_key_status",
	},
	{
		.code   = GPIO_KEY_BACKWARD,
                .gpio   = GPIO_2_14,
                .desc   = "backward button",
                .type   = EV_KEY,
                .active_low     = 0,
                ...
                .longpress_time = 2000,
                .wakeup = 1,
                .key_status = "backward_key_status",
	},
	{
		.code   = GPIO_KEY_FORWARD,
                .gpio   = GPIO_2_9,
                .desc   = "forward button",
                .type   = EV_KEY,
                .active_low     = 0,
