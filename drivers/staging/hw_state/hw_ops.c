...
#define PLATFORM_NAME	"ep8"
//#define	HW_CONFIG 0x0000000011031908	
#define HW_CONFIG 285415688
...
//	int ret = 0;
	...
	if(batt_cap <= 15)
	{
		...
		{
			*low_batt_status = 2;
			printk("low battery, below 15%...\n");
		}
		else if(batt_cap >= 3)
		{
			*low_batt_status = 1;
			printk("low battery, below 5%...\n");
		}
		else
		{
			*low_batt_status = 0;
			printk("critical low battery, below 3%, auto power off...\n");
//			hw_poweroff();
		}
	}
	else
